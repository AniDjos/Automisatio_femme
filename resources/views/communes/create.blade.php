...
@section('name', 'Créer une Commune')

@section('content')
<div class="containerer">
    <h1 class="page-title">Créer une Nouvelle Commune</h1>

    <form action="{{ route('communes.store') }}" method="POST">
        @csrf
        <div class="form-group">
            <label for="commune_libelle">Nom de la Commune :</label>
            <input type="text" name="commune_libelle" id="commune_libelle" class="form-control" placeholder="Entrez le nom de la commune" required>
        </div>
