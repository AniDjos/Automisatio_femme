    ...
    <div class="container-prin">
        ...
        <div class="container-groupement">
            ...
            <div>
                ...
                <p><i class="fas fa-map-marker-alt"></i>{{ $groupement->departement_nom ?? 'Non spécifié' }} {{ $groupement->commune_nom ?? 'Non spécifiée' }} {{ $groupement->arrondissement_nom ?? 'Non spécifiée' }} {{ $groupement->quartier_nom ?? 'Non spécifiée' }}</p>
                <p><i class="fas fa-calendar-alt"></i> Créé le : {{ $groupement->date_creation }}</p>
                <p><i class="fas fa-user"></i> Etat: @if ($groupement->statut)
