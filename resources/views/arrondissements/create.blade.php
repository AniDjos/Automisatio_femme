...
@section('name', 'Créer un Arrondissement')

@section('content')
<div class="containerer">
    <h1 class="page-title">Créer un Nouvel Arrondissement</h1>

    <form action="{{ route('arrondissements.store') }}" method="POST">
        @csrf
        <div class="form-group">
            <label for="arrondissement_libelle">Nom de l'Arrondissement :</label>
            <input type="text" name="arrondissement_libelle" id="arrondissement_libelle" class="form-control" placeholder="Entrez le nom de l'arrondissement" required>
        </div>
