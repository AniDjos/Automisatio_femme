...
Route::get('/groupements/nouveau', [GroupementController::class, 'create'])->name('groupements.create');

Route::get('/groupements/{id}', [GroupementController::class, 'show'])->name('groupements.show');

Route::get('/groupements/{id}/edit', [GroupementController::class, 'edit'])->name('groupements.edit');
...
Route::get('/membres/nouveau', [MembreController::class, 'create'])->name('membres.create');
...
Route::get('/quartiers/nouveau', [QuartierController::class, 'create'])->name('quartier.create');

Route::get('/quartiers', [QuartierController::class, 'index'])->name('quartier.index');

Route::get('/quartiers/{id}/edit', [QuartierController::class, 'edit'])->name('quartier.edit');
...
Route::get('/cps', [CpsController::class, 'index'])->name('cps.index');

Route::get('/cps/nouveau', [CpsController::class, 'create'])->name('cps.create');

Route::get('/cps/{id}/edit', [CpsController::class, 'edit'])->name('cps.edit');
...
Route::get('/agrementss', [AgrementController::class, 'index'])->name('agrement.index');

Route::get('/agrements/nouveau', [AgrementController::class, 'create'])->name('agrement.create');

Route::post('/agrementss', [AgrementController::class, 'store'])->name('agrement.store');

Route::get('/agrements/{id}/edit', [AgrementController::class, 'edit'])->name('agrement.edit');
...
Route::get('/agrements/{id}', [App\Http\Controllers\AgrementController::class, 'show'])->name('agrement.show');
...
Route::get('/filieres', [App\Http\Controllers\FiliereController::class, 'index'])->name('filiere.index');
...
Route::get('/filiere/{id}/edit', [App\Http\Controllers\FiliereController::class, 'edit'])->name('filiere.edit');
 ...
 */
 ...
 Route::get('/equipement/create', [App\Http\Controllers\EquipementController::class, 'create'])->name('equipement.create');
 
 Route::post('/equipement', [App\Http\Controllers\EquipementController::class, 'store'])->name('equipement.store');

 Route::get('/equipements', [App\Http\Controllers\EquipementController::class, 'index'])->name('equipement.index');

 Route::get('/equipements/{id}/edit', [App\Http\Controllers\EquipementController::class, 'edit'])->name('equipement.edit');
...
Route::get('/appuis/create', [App\Http\Controllers\AppuiController::class, 'create'])->name('appuis.create');

Route::post('/appuis', [App\Http\Controllers\AppuiController::class, 'store'])->name('appuis.store');

Route::get('/appuis', [App\Http\Controllers\AppuiController::class, 'index'])->name('appuis.index');

Route::get('/appuis/{id}/edit', [App\Http\Controllers\AppuiController::class, 'edit'])->name('appuis.edit');
 ...
 */
Route::get('/communes/create', [App\Http\Controllers\CommuneController::class, 'create'])->name('communes.create');
...
Route::get('/communes/{id}/edit', [App\Http\Controllers\CommuneController::class, 'edit'])->name('communes.edit');
 ...
 */
Route::get('/arrondissements/create', [App\Http\Controllers\ArrondissementController::class, 'create'])->name('arrondissements.create');

Route::post('/arrondissements', [App\Http\Controllers\ArrondissementController::class, 'store'])->name('arrondissements.store');

Route::get('/arrondissements', [App\Http\Controllers\ArrondissementController::class, 'index'])->name('arrondissements.index');

Route::get('/arrondissements/{id}/edit', [App\Http\Controllers\ArrondissementController::class, 'edit'])->name('arrondissements.edit');
...
Route::get('/utilisateurs/nouveau', [\App\Http\Controllers\UtilisateurController::class, 'create'])->name('utilisateurs.create');
