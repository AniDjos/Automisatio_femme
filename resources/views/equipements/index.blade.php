                    ...
                    @forelse($equipements as $equipement)
                        <tr class="equipment-row">
                            ...
                            <td class="cell-status">
                                <span class="status-badge {{ strtolower(str_replace(' ', '-', $equipement->stat_equipement)) }}">
                            ...
                            <td class="cell-actions">
                                <div class="action-buttons">
                                    <a href="{{ route('equipement.edit', $equipement->equipment_id) }}" class="action-btn edit-btn" title="Modifier">
                                        <i class='bx bx-edit-alt'></i>
                                    </a>
                                    
                                    <form action="{{ route('equipement.destroy', $equipement->equipment_id) }}" method="POST" class="delete-form">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="action-btn delete-btn" title="Supprimer" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet équipement ?')">
...
.column-difficulties, .column-needs {
    max-width: 250px;
    min-width: 200px;
}
